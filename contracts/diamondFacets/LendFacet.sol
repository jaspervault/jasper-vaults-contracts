...
contract LendFacet is ILendFacet {
    ...
    function setBorrowerPutOrderNftInfo(
        ...
        Lend storage ds = diamondStorage();
        ds.borrowerPutOrder[_borrower].underlyingNftID = _collateralNftId;
        ds.borrowerPutOrder[_borrower].underlyingAmount = _newLiquidity;
    }
    ...
    function setLenderCallOrderNftInfo(
        ...
        Lend storage ds = diamondStorage();
        ds.lenderCallOrder[_lender].underlyingNftID = _collateralNftId;
        ds.lenderCallOrder[_lender].underlyingAmount = _newLiquidity;
    }
