    ...
    Initializable
{
    ...
    function vaultVaild() internal view returns (IVaultVaild) {
        return IVaultVaild(moduleManager);
    }
    ...
    function _validModule(
        ...
        vaultVaild().validVaultModuleV2(module, _value, func);
    }
     ...
     */
    function initialize(address anOwner,address _moduleManager) public virtual initializer {
    ...
    function upgradeToAndCall(
        ...
        _validModule(
            msg.sender,
            0,
            abi.encodePacked(this.upgradeToAndCall.selector)
        );
        vaultVaild().removeVault(address(this));
        _authorizeUpgrade(newImplementation);
