...
contract GMXWrapV2Adapter is IGMXAdapter {
  ...
  returns (address, uint256, bytes memory)
  {
    ...
    bytes memory callData = abi.encodeWithSignature(
      ...
      request._path,request._amountIn,request._minOut,request._sizeDelta,request._isLong,request._acceptablePrice,request._executionFee,request._referralCode,request._callbackTarget
    );
